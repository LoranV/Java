        ...
        switch (ask) {
            ...
            case 2:
                ...
                if (Distance(x1,y1,x2,y2)<Distance(x1,y1,x3,y3))
                    System.out.println("Найблища точка до А - В("+x2+","+y2+")\tДистанція: "+Distance(x1,y1,x2,y2));
                else
                    System.out.println("Найблища точка до А - С("+x2+","+y2+")\tДистанція: "+Distance(x1,y1,x3,y3));
                break;
            case 3:
                System.out.println("Введіть цифру(1-7), щоб дізнатись колір веселки");
